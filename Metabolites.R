...
metabolite <- metabolites%>%
  select('No.','Eid','Total_Cholesterol','Total_Cholines',' L_VLDL ',' IDL ','M_VLDL','S_VLDL','VS_VLDL','L_LDL',' M_LDL ',' VL_HDL',' M_HDL','Total_Phospholipids_in_Lipoprotein','Linoleic_Acid','Omega-3 Fatty_Acids','Omega-6_Fatty_Acids','DHA','Degree of Unsaturation','Apolipoprotein_B','Apolipoprotein_A1','Glucose','Lactate','Pyruvate','Citrate','Phosphatidylcholines','Creatinine','Albumin','Acetate','Acetoacetate','Acetone')
